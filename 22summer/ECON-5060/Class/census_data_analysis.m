function census_data_analysis
% Select data given its main attributes:
% 1. age
% 2. gender=0 if male or 1 if female
% 3. years of education
x=[[1:10];[18 17 22 23 17 25 16 17 22 26];[1 0 0 1 0 1 0 1 1 1]]';
...
%additional data about years of education (y)
y=[9 13 10 12 12 17 10 12 8 18]';
x2=[x y];


% High school
% high school (<12) is 0, 1 is college or grad school
high_school_ed=edu_selector(x2,0);

%college grad
grad_ed=edu_selector(x2,1)
