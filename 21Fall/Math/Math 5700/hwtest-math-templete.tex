...
\newcommand{\hmwkDueDate}{August 13, 2021}
\newcommand{\hmwkClass}{Calculus}
\newcommand{\hmwkClassTime}{MTWR}
\newcommand{\hmwkClassInstructor}{Instructor Chunyu Qu}
\newcommand{\hmwkAuthorName}{\textbf{Wei Ye} }
